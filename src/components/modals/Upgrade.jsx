...
export default function Upgrade({ setType }) {
		...
		<div className='h-full animate-fadeIn'>
			<div className='h-full flex justify-center items-center'>
				<div className='relative h-full flex justify-center items-center rounded-2xl bg-transparent-b-70'>
					<Button className='absolute top-4 right-4' onClick={() => setType(null)}>
					...
					<div className='bg-black h-full p-4 rounded-2xl font-bold text-sm'>
						<div className='h-full rounded-b-2xl overflow-y-auto'>
							...
							<div className='max-w-[560px] grid grid-cols-2 gap-x-4 gap-y-2'>
								<div className='flex flex-col items-center col-span-1 bg-bg-200 rounded-2xl p-4'>
								...
								<div className='flex flex-col items-center col-span-1 bg-bg-200 rounded-2xl border border-primary p-4'>
